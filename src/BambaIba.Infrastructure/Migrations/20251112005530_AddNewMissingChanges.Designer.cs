...
namespace BambaIba.Infrastructure.Migrations
{
    ...
    [Migration("20251112005530_AddNewMissingChanges")]
    partial class AddNewMissingChanges
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BambaIba.Domain.Audios.Audio", b =>
                {
                    ...
                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("ix_audios_created_at");

                    b.HasIndex("Genre")
                        .HasDatabaseName("ix_audios_genre");

                    b.HasIndex("Status")
                        .HasDatabaseName("ix_audios_status");
            ...
            modelBuilder.Entity("BambaIba.Domain.PlaylistVideos.PlaylistVideo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
