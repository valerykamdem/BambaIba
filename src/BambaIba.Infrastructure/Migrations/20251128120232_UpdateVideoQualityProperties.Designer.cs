...
namespace BambaIba.Infrastructure.Migrations
{
    ...
    [Migration("20251128120232_UpdateVideoQualityProperties")]
    partial class UpdateVideoQualityProperties
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BambaIba.Domain.Comments.Comment", b =>
                {
                    b.HasOne("BambaIba.Domain.Videos.Video", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_comments_videos_media_id");
                });
            ...
            modelBuilder.Entity("BambaIba.Domain.Likes.Like", b =>
                {
                    b.HasOne("BambaIba.Domain.Videos.Video", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_likes_videos_media_id");
                });
